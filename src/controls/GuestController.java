...
public class GuestController implements Serializable {
    ...
    private static GuestController thisInstance = null;
    ...
    public static GuestController getInstance() {
        ...
        if (thisInstance==null) // not already loaded
        {
            ...
            thisInstance = dataController.loadGuestController();

            if (thisInstance==null)
                thisInstance = new GuestController(); // loading failure; resets controller
        }
        return thisInstance;
    }
    ...
    public String createGuest(String identity, String name, String addr, String contact, String card, String country, String nationality, int genderOption) {
        ...
        if(contact.length() < 8)
        {
            return "Invalid contact. Guest is not created. Please enter at least 8 numbers.";
        }
